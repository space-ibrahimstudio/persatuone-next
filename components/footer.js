...
export function Footer({ componentId }) {
  ...
  useEffect(() => {
    ...
    svg.setAttribute("width", getComputedStyle(document.documentElement).getPropertyValue("--pixel-18"));
  }, []);
  ...
  return (
    <footer id={componentId} className={styles.footer}>
      <div className={styles.footerNav}>
        <div className={styles.footerLogo} onClick={() => scrollToSection("hero-section")}>
          <img className={styles.footerLogoImg} loading="lazy" alt={componentId} src="/svg/logo.svg" />
        </div>
        <div className={styles.footerMenu}>
          <div className={styles.footerMenuWrapper}>
            <h1 className={styles.footerMenuTitle}>About us</h1>
            <h2 onClick={() => scrollToSection("about-us")} className={styles.footerMenuLink}>
              Who we are
            </h2>
            <h2 onClick={() => scrollToElement("factory-section")} className={styles.footerMenuLink}>
              Factory
            </h2>
            <h2 onClick={() => scrollToElement("facility-section")} className={styles.footerMenuLink}>
              Our facilities
            </h2>
            <h2 onClick={() => scrollToElement("why-section")} className={styles.footerMenuLink}>
              Why choose us
            </h2>
            <h2 onClick={() => scrollToSection("gallery-showcase")} className={styles.footerMenuLink}>
              Gallery
            </h2>
          </div>
          <div className={styles.footerMenuWrapper}>
            <h1 className={styles.footerMenuTitle}>Products & Brands</h1>
            <h2 onClick={() => scrollToSection("our-products")} className={styles.footerMenuLink}>
              Cocoa
            </h2>
            <h2 onClick={() => scrollToElement("coffee-section")} className={styles.footerMenuLink}>
              Coffee
            </h2>
            <h2 onClick={() => scrollToElement("certi-section")} className={styles.footerMenuLink}>
              Certifications
            </h2>
            <h2 onClick={() => scrollToSection("our-brands")} className={styles.footerMenuLink}>
              Cartenz Cocoa Powder
            </h2>
            <h2 onClick={() => scrollToElement("celco-section")} className={styles.footerMenuLink}>
              Celebes Coffee
            </h2>
          </div>
          <div className={styles.footerMenuWrapper}>
            <h1 className={styles.footerMenuTitle}>Socials</h1>
            <div style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: "var(--pixel-10)" }}>
              <svg id="facebook-icons" height="100%" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M16.9846 8.5445C16.9846 3.82556 13.1829 0 8.49319 0C3.80168 0.000884523 0 3.82556 0 8.54538C0 12.8088 3.10556 16.3442 7.16464 16.9846V11.0141H5.00994V8.54627H7.16641V6.66223C7.16641 4.5208 8.43481 3.33819 10.3746 3.33819C11.3033 3.33819 12.2754 3.50448 12.2754 3.50448V5.60611H11.2051C10.1508 5.60611 9.82175 6.26508 9.82175 6.94174V8.5445H12.1755L11.7995 11.0132H9.81998V16.9837C13.8799 16.3425 16.9846 12.8088 16.9846 8.5445Z" fill="currentColor" />
              </svg>
            ...
            <div style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: "var(--pixel-10)" }}>
              <svg id="instagram-icons" height="100%" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <div style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: "var(--pixel-10)" }}>
              <svg id="linkedin-icons" height="100%" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
      ...
      <div className={styles.footerFooter}>
        <h1 className={styles.footerMenuLink}>© 2024 Persatu.one. All right reserved.</h1>
